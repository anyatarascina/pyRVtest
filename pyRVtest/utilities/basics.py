...
def format_table_notes(
        header: Sequence, *data: Sequence, title: Optional[str] = None, notes: Optional[Sequence], include_border: bool = True,
        include_header: bool = True, line_indices: Container[int] = ()) -> str:
    """Format table information as a string, which has fixed widths, vertical lines after any specified indices, and
    optionally a title, border, and header.
    """
...
def format_table_notes_sub(
        header: Sequence, subheader:Sequence, *data: Sequence, title: Optional[str] = None, notes: Optional[Sequence], include_border: bool = True,
        include_header: bool = True, include_subheader: bool = True, line_indices: Container[int] = ()) -> str:
    """Format table information as a string, which has fixed widths, vertical lines after any specified indices, and
    optionally a title, border, and header.
    """
