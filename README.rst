...
* Exposes the per-model Villas-Boas pass-through matrix on ``ProblemResults`` (``passthrough_matrix``) for inspection of the Dearing et al. (2026) distinguishability conditions.
