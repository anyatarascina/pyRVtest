...
class ProblemResults(Results):
    ...
    def __init__(
            ...
            #last_results: Optional['ProblemResults']
            #progress: 'Progress', last_results: Optional['ProblemResults'], step: int, last_step: bool,
            ...
            #extra_micro_covariances: Optional[Array], center_moments: bool, W_type: str, se_type: str
            ) -> None:
