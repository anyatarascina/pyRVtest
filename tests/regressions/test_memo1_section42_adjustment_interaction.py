...
@pytest.mark.xfail(
    strict=True,
    reason=(
        "v0.4-refactor did not add the gate; tracked for v0.5. "
        "The combination biases the demand-adjusted variance because "
        "_compute_demand_adjustment_gradient misses the dgamma/dtheta "
        "channel from the IV correction."
    )
)
