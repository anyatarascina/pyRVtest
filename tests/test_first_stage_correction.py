...
# ---------------------------------------------------------------------------
# Shared fixture: ``logit_dgp_and_estimation`` (logit DGP estimated via PyBLP,
# with nonzero xi for a nontrivial demand adjustment) now lives in
# ``tests/conftest.py`` so it can be reused by test_demand_adjustment_precompute.
# ---------------------------------------------------------------------------
